...
<article class="content_styles" role="article">
	<div class="padding_block">
		<div class="tab_4 desk_6 desk_large_8 margin_auto double_single_block">
			<header>
		...
		<div class="double_single_block">
			<div class="padding_block">
				<?php foreach($responsive_works as $work) :
					...
					<div class="mob_2 tab_2 desk_2 desk_large_3 responsive_grid_gutter single_block">
